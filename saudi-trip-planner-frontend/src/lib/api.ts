...
function normalizePlace(raw: any): Place {
  return {
    ...
    ranking_score: optionalNumber(raw.ranking_score),
    rank: optionalNumber(raw.rank),
    preference_match: optionalNumber(raw.preference_match),
    budget_fit: optionalNumber(raw.budget_fit),
    budget_difference: optionalNumber(raw.budget_difference),
    budget_status: raw.budget_status,
    ...
    distance_fit: optionalNumber(raw.distance_fit),
    place_quality: optionalNumber(raw.place_quality),
    estimated_travel_minutes_from_center: optionalNumber(raw.estimated_travel_minutes_from_center),
    diversity_adjusted_score: optionalNumber(raw.diversity_adjusted_score),
    final_rank: optionalNumber(raw.final_rank),
    cost_estimate_basis: raw.cost_estimate_basis,
